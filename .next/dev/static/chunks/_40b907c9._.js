...
const TextConnectionLines = ({ blocks, containerRef })=>{
    ...
    const [, setForceUpdate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    `;
            ...
            blocks.forEach({
                "TextConnectionLines.useCallback[drawConnections]": (block)=>{
                    ...
                    block.textConnections.forEach({
                        "TextConnectionLines.useCallback[drawConnections]": (connection)=>{
                   ...
                   H ${sourceLeftEdge}`;
                            ...
                            const createDot = {
                                "TextConnectionLines.useCallback[drawConnections].createDot": (x, y, size = 4)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TextConnectionLines.useEffect": ()=>{
            const timeoutId = setTimeout({
                "TextConnectionLines.useEffect.timeoutId": ()=>{
                    drawConnections();
                }
            }["TextConnectionLines.useEffect.timeoutId"], 150);
            return ({
                "TextConnectionLines.useEffect": ()=>clearTimeout(timeoutId)
            })["TextConnectionLines.useEffect"];
        }
    }["TextConnectionLines.useEffect"], [
        drawConnections
        ...
        "TextConnectionLines.useEffect": ()=>{
            const handleUpdate = {
                "TextConnectionLines.useEffect.handleUpdate": ()=>{
                    setForceUpdate({
                        "TextConnectionLines.useEffect.handleUpdate": (prev)=>prev + 1
                    }["TextConnectionLines.useEffect.handleUpdate"]);
...
_s(TextConnectionLines, "WR4Mhjr9cmuQzAbwEfR18qyARNU=");
...
_s(EditorView, "h/hNirj+8pxS/VHsw9Aaq/BagIQ=");
_c = EditorView;
var _c;
...
//# sourceMappingURL=_40b907c9._.js.map