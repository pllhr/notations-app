...
;
;
const ImageBlock = /*#__PURE__*/ _s(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].memo(_c = _s(({ id, src, onDelete, className = '', isLoading = false })=>{
    _s();
    ...
    const handleLoad = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ImageBlock.useCallback[handleLoad]": (e)=>{
            setImageLoaded(true);
            setImageError(false);
    ...
    }["ImageBlock.useCallback[handleLoad]"], []);
    const handleError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ImageBlock.useCallback[handleError]": ()=>{
            setImageLoaded(true);
            setImageError(true);
        }
    }["ImageBlock.useCallback[handleError]"], []);
    const handleDownload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ImageBlock.useCallback[handleDownload]": ()=>{
    ...
    const handleCopyUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ImageBlock.useCallback[handleCopyUrl]": async ()=>{
            try {
                await navigator.clipboard.writeText(src);
                setCopied(true);
                setTimeout({
                    "ImageBlock.useCallback[handleCopyUrl]": ()=>setCopied(false)
                }["ImageBlock.useCallback[handleCopyUrl]"], 2000);
            } catch (e) {
                console.error('Failed to copy URL', e);
            }
        }
    }["ImageBlock.useCallback[handleCopyUrl]"], [
        src
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ImageBlock.useEffect": ()=>{
            const handleKeyDown = {
                "ImageBlock.useEffect.handleKeyDown": (e)=>{
                    if (e.key === 'Escape' && isFullscreen) {
                        setIsFullscreen(false);
                    }
                }
            }["ImageBlock.useEffect.handleKeyDown"];
            document.addEventListener('keydown', handleKeyDown);
            return ({
                "ImageBlock.useEffect": ()=>document.removeEventListener('keydown', handleKeyDown)
            })["ImageBlock.useEffect"];
        }
    }["ImageBlock.useEffect"], [
        isFullscreen
...
}, "ZvX018gwNPh2R8NzDRORmQQxUFc=")), "ZvX018gwNPh2R8NzDRORmQQxUFc=");
_c1 = ImageBlock;
...
const ConfirmationModal = ({ isOpen, title, message, onConfirm, onCancel, variant = 'danger', confirmText = 'Confirmar', cancelText = 'Cancelar' })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConfirmationModal.useEffect": ()=>{
            if (!isOpen) return;
            const handleKeyDown = {
                "ConfirmationModal.useEffect.handleKeyDown": (e)=>{
                    if (e.key === 'Escape') {
                        e.preventDefault();
                        onCancel();
                    }
                }
            }["ConfirmationModal.useEffect.handleKeyDown"];
            window.addEventListener('keydown', handleKeyDown);
            return ({
                "ConfirmationModal.useEffect": ()=>window.removeEventListener('keydown', handleKeyDown)
            })["ConfirmationModal.useEffect"];
        }
    }["ConfirmationModal.useEffect"], [
        isOpen,
...
_s(ConfirmationModal, "R22TbI77Wd03HDH3wv2RN7aJ7BE=");
...
const TextLinkingMode = ({ isActive, sourceText, sourceBlockId, currentColor, onColorChange, onSelectTarget, onCancel })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TextLinkingMode.useEffect": ()=>{
            if (!isActive) return;
            const handleMouseUp = {
                "TextLinkingMode.useEffect.handleMouseUp": (e)=>{
            ...
            const handler = {
                "TextLinkingMode.useEffect.handler": (e)=>setTimeout({
                        "TextLinkingMode.useEffect.handler": ()=>handleMouseUp(e)
                    }["TextLinkingMode.useEffect.handler"], 10)
            }["TextLinkingMode.useEffect.handler"];
            document.addEventListener('mouseup', handler);
            return ({
                "TextLinkingMode.useEffect": ()=>document.removeEventListener('mouseup', handler)
            })["TextLinkingMode.useEffect"];
        }
    }["TextLinkingMode.useEffect"], [
        isActive,
    ...
    const handleConnect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TextLinkingMode.useCallback[handleConnect]": ()=>{
            ...
            setTimeout({
                "TextLinkingMode.useCallback[handleConnect]": ()=>{
                    ...
                    }["TextLinkingMode.useCallback[handleConnect]"], 400);
                }
            }["TextLinkingMode.useCallback[handleConnect]"], 200);
        }
    }["TextLinkingMode.useCallback[handleConnect]"], [
        selectedTargetText,
        selectedTargetBlockId,
...
_s(TextLinkingMode, "c76g52xP4wUNjUmGrKltWOuIpcg=");
_c = TextLinkingMode;
var _c;
...
const TextConnectionLines = ({ blocks, containerRef })=>{
    ...
    const allConnections = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TextConnectionLines.useMemo[allConnections]": ()=>{
            const result = [];
            blocks.forEach({
                "TextConnectionLines.useMemo[allConnections]": (block)=>{
                    if (block.textConnections && block.textConnections.length > 0) {
                        block.textConnections.forEach({
                            "TextConnectionLines.useMemo[allConnections]": (conn)=>{
                                result.push({
                                    connection: conn,
                                    blockId: block.id
                                });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TextConnectionLines.useEffect": ()=>{
            const handleScroll = {
                "TextConnectionLines.useEffect.handleScroll": ()=>scheduleUpdate()
            }["TextConnectionLines.useEffect.handleScroll"];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
        ...
        children: [
            ...
            (()=>{
                ...
                const sourceEdge = 8;
                return Array.from(dotMap.entries()).map(([key, dot])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("circle", {
                        cx: sourceEdge - 2,
                        cy: dot.y,
                        r: 5,
                        fill: dot.color,
...
_s(TextConnectionLines, "vXNwN9LzZvTZKGpDEFagLVLiPyM=");
...
const EditorView = ({ activeNote, onUpdateNote, onDeleteNote, hasUnsavedChanges, onSave })=>{
    ...
    const [linkDeleteModal, setLinkDeleteModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Available fonts
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditorView.useEffect": ()=>{
            ...
            const handleLinkDeleteClick = {
                "EditorView.useEffect.handleLinkDeleteClick": (e)=>{
                    const target = e.target;
            ...
            }["EditorView.useEffect.handleLinkDeleteClick"];
            const editorEl = editorRef.current;
            if (editorEl) {
                editorEl.addEventListener('click', handleLinkDeleteClick, true);
                return ({
                    "EditorView.useEffect": ()=>editorEl.removeEventListener('click', handleLinkDeleteClick, true)
                })["EditorView.useEffect"];
            }
        }
    }["EditorView.useEffect"], [
    ...
    const handleConfirmLinkDelete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EditorView.useCallback[handleConfirmLinkDelete]": ()=>{
                ...
                "EditorView.useCallback[handleConfirmLinkDelete]": ()=>{
                    ...
                    if (blockEl) {
                        ...
                        const newBlocks = activeNote.blocks.map({
                            "EditorView.useCallback[handleConfirmLinkDelete].newBlocks": (b)=>b.id === blockId ? {
                                    ...b,
                                    content: newContent
                                } : b
                        }["EditorView.useCallback[handleConfirmLinkDelete].newBlocks"]);
                        onUpdateNote({
                            ...activeNote,
                            blocks: newBlocks
                        }, 'PUSH');
            ...
            }["EditorView.useCallback[handleConfirmLinkDelete]"], 300);
        }
    }["EditorView.useCallback[handleConfirmLinkDelete]"], [
        linkDeleteModal,
        activeNote,
        ...
        "EditorView.useCallback[handleFileUpload]": async (file, targetBlockId)=>{
            ...
            if (insertionBlockId) {
                const index = newBlocks.findIndex({
                    "EditorView.useCallback[handleFileUpload].index": (b)=>b.id === insertionBlockId
...
_s(EditorView, "zrzx6Lk9O7+r8bk35Hcl+tyd1kU=");
_c = EditorView;
var _c;
...
const CanvasView = ({ notes, onNoteSelect, onNoteMove, onConnectNotes, onDeleteNote, isDarkMode, tagsWithColors = [], selectedNoteId })=>{
    ...
    const tagColorMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CanvasView.useMemo[tagColorMap]": ()=>{
            const map = new Map();
            tagsWithColors.forEach({
                "CanvasView.useMemo[tagColorMap]": (tag)=>{
...
_s(CanvasView, "n+I51UGQ2x4s9o6jdmLxaypWT8I=");
_c = CanvasView;
    ...
    if (lodLevel === 'compact') {
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
            ...
            children: [
                ...
                shortPreview && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
const GraphView = ({ notes, onNoteSelect, onDeleteNote, isDarkMode })=>{
    ...
    const simulationRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const clusterData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GraphView.useMemo[clusterData]": ()=>{
            const tagMap = new Map(); // tag -> noteIds
            // Helper to clean tag text
            const cleanTag = {
                "GraphView.useMemo[clusterData].cleanTag": (tag)=>{
                    const tmp = document.createElement("DIV");
                    tmp.innerHTML = tag;
                    return (tmp.textContent || tmp.innerText || tag).trim();
                }
            }["GraphView.useMemo[clusterData].cleanTag"];
            notes.forEach({
                "GraphView.useMemo[clusterData]": (note)=>{
            ...
            tagArray.forEach({
                "GraphView.useMemo[clusterData]": (tag, i)=>{
                    clusters.push({
                        tag,
                        x: 0,
                        y: 0,
    ...
    const getConnectedNodes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GraphView.useCallback[getConnectedNodes]": (nodeId)=>{
            const connected = new Set();
            connected.add(nodeId);
            notes.forEach({
                "GraphView.useCallback[getConnectedNodes]": (note)=>{
                    if (note.id === nodeId) {
                        note.connections.forEach({
                            "GraphView.useCallback[getConnectedNodes]": (id)=>connected.add(id)
                        }["GraphView.useCallback[getConnectedNodes]"]);
                    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GraphView.useEffect": ()=>{
            ...
            const animate = {
                "GraphView.useEffect.animate": (currentTime)=>{
                    animationRef.current = requestAnimationFrame(animate);
                }
            }["GraphView.useEffect.animate"];
            animationRef.current = requestAnimationFrame(animate);
            return ({
                "GraphView.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GraphView.useEffect": ()=>{
            ...
            clusters.forEach({
                "GraphView.useEffect": (c)=>clusterLookup.set(c.tag, c)
            }["GraphView.useEffect"]);
            // Helper to clean tag text
            const cleanTag = {
                "GraphView.useEffect.cleanTag": (tag)=>{
                    const tmp = document.createElement("DIV");
                    tmp.innerHTML = tag;
                    return (tmp.textContent || tmp.innerText || tag).trim();
                }
            }["GraphView.useEffect.cleanTag"];
            // Transform notes to enhanced graph nodes
            const nodes = notes.map({
                "GraphView.useEffect.nodes": (n, i)=>{
            ...
            glowFilter.append("feMerge").selectAll("feMergeNode").data([
                "blur",
                "SourceGraphic"
            ]).join("feMergeNode").attr("in", {
                "GraphView.useEffect": (d)=>d
            }["GraphView.useEffect"]);
            // Cluster glow filter
            ...
            const forceCluster = {
                "GraphView.useEffect.forceCluster": ()=>{
                    const strength = 0.15;
                    return ({
                        "GraphView.useEffect.forceCluster": (alpha)=>{
                            nodes.forEach({
                                "GraphView.useEffect.forceCluster": (node)=>{
            ...
            }["GraphView.useEffect.simulation"]).distance(80).strength(0.4)).force("charge", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$force$2f$src$2f$manyBody$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forceManyBody$3e$__["forceManyBody"]().strength(-150)).force("center", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$force$2f$src$2f$center$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forceCenter$3e$__["forceCenter"](centerX, centerY).strength(0.05)).force("collide", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$force$2f$src$2f$collide$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forceCollide$3e$__["forceCollide"]().radius(35)).force("cluster", forceCluster()).velocityDecay(0.5).alphaDecay(0.015);
            simulationRef.current = simulation;
            // Draw cluster backgrounds first
            const clusterGroup = svg.append("g").attr("class", "clusters");
            clusters.forEach({
                "GraphView.useEffect": (cluster)=>{
                    // Cluster area glow
            ...
            link.each({
                "GraphView.useEffect": function() {
                    const g = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$select$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__select$3e$__["select"](this);
            ...
            // Draw nodes
            const node = nodesGroup.selectAll("g").data(nodes.sort({
                "GraphView.useEffect.node": (a, b)=>a.z - b.z
            }["GraphView.useEffect.node"])).join("g").attr("cursor", "pointer").attr("class", "neural-node").call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$drag$2f$src$2f$drag$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__drag$3e$__["drag"]().on("start", dragstarted).on("drag", dragged).on("end", dragended)).on("click", {
            ...
            }["GraphView.useEffect.node"]).on("mouseenter", {
                "GraphView.useEffect.node": (event, d)=>{
                    setHoveredNodeId(d.id);
                    setHoveredCluster(d.clusterId);
                }
            }["GraphView.useEffect.node"]).on("mouseleave", {
            ...
            node.append("circle").attr("class", "node-glow").attr("r", 20).attr("fill", {
                "GraphView.useEffect": (d)=>{
            ...
            }["GraphView.useEffect"]).attr("opacity", 0.2).attr("filter", "url(#neural-glow)");
            // Main node circle
            node.append("circle").attr("class", "node-core").attr("r", {
                "GraphView.useEffect": (d)=>8 + d.z * 4
            }["GraphView.useEffect"]).attr("fill", {
                "GraphView.useEffect": (d)=>{
                    const clusterColor = clusterLookup.get(d.clusterId)?.color;
                    return d.color && d.color !== '#000000' ? d.color : clusterColor || (isDarkMode ? '#90b0ff' : '#4080e0');
                }
            }["GraphView.useEffect"]).attr("stroke", isDarkMode ? "rgba(255,255,255,0.3)" : "rgba(0,0,0,0.1)").attr("stroke-width", 1.5);
            // Inner highlight
            node.append("circle").attr("class", "node-highlight").attr("r", {
                "GraphView.useEffect": (d)=>3 + d.z * 2
            }["GraphView.useEffect"]).attr("cx", -2).attr("cy", -2).attr("fill", "rgba(255,255,255,0.4)");
            // Labels
            node.append("text").attr("x", {
                "GraphView.useEffect": (d)=>12 + d.z * 4
            }["GraphView.useEffect"]).attr("y", 4).text({
                "GraphView.useEffect": (d)=>stripHtml(d.title || "Untitled")
            }["GraphView.useEffect"]).style("font-family", "'Inter', sans-serif").style("font-size", {
                "GraphView.useEffect": (d)=>`${10 + d.z * 3}px`
            }["GraphView.useEffect"]).style("font-weight", "600").style("letter-spacing", "0.02em").attr("fill", isDarkMode ? "rgba(255,255,255,0.9)" : "rgba(0,0,0,0.85)").style("filter", {
                "GraphView.useEffect": (d)=>`blur(${(1 - d.z) * 0.5}px)`
            }["GraphView.useEffect"]).clone(true).lower().attr("fill", "none").attr("stroke", isDarkMode ? "rgba(0,0,0,0.8)" : "rgba(255,255,255,0.9)").attr("stroke-width", 3).style("filter", "none");
            ...
            simulation.on("tick", {
                "GraphView.useEffect": ()=>{
                    ...
                    link.selectAll(".synapse-pulse").attr("x1", {
                        "GraphView.useEffect": (d)=>d.source.x
                    }["GraphView.useEffect"]).attr("y1", {
                        "GraphView.useEffect": (d)=>d.source.y
                    }["GraphView.useEffect"]).attr("x2", {
                    ...
                    node.selectAll(".node-glow").attr("opacity", {
                        "GraphView.useEffect": (d)=>0.15 + Math.sin(t * 1.5 + d.breathPhase) * 0.1
                    }["GraphView.useEffect"]);
                }
            }["GraphView.useEffect"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GraphView.useEffect": ()=>{
            ...
            svg.selectAll(".neural-node").transition().duration(200).style("opacity", {
                "GraphView.useEffect": (d)=>{
            ...
            // Update link opacity
            svg.selectAll(".synapse").transition().duration(200).style("opacity", {
                "GraphView.useEffect": (d)=>{
                    if (!hoveredNodeId) return 1;
            ...
            svg.selectAll(".cluster-bg").transition().duration(300).attr("opacity", {
                "GraphView.useEffect": function() {
                    if (!hoveredCluster) return 0.08;
                    const circle = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$select$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__select$3e$__["select"](this);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            clusterData.clusters.map((cluster)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex items-center gap-2",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "w-3 h-3 rounded-full",
                            ...
                            clusterData.clusters.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(GraphView, "xaaCz+3+6n+ZHTWnYbAu3bdbs/8=");
_c = GraphView;
var _c;
...
const NotationsApp = ({ user })=>{
    ...
    const [tagsWithColors, setTagsWithColors] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotationsApp.useEffect": ()=>{
...
_s(NotationsApp, "QUmvC2cHhRZ4/kPVPzyXtxpYDkY=", false, function() {
    return [
...
//# sourceMappingURL=_d48d2579._.js.map