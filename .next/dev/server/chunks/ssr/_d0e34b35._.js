            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        selectedTargetText ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
;
;
// Helper to find text position within a block element
...
const TextConnectionLines = ({ blocks, containerRef })=>{
    ...
    const [, setForceUpdate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    // Margin offset for vertical lines (how far left from the content)
    const MARGIN_OFFSET = 30;
    const LINE_SPACING = 8; // Space between multiple connection lines
    ...
    `;
        ...
        // Track line positions to avoid overlaps
        let connectionIndex = 0;
        // Draw connections for each block
        blocks.forEach((block)=>{
            if (!block.textConnections || block.textConnections.length === 0) return;
            const sourceBlockEl = document.getElementById(`block-${block.id}`);
            if (!sourceBlockEl) return;
            block.textConnections.forEach((connection)=>{
                // Find source text position
                const sourcePos = findTextPosition(sourceBlockEl, connection.sourceText);
                if (!sourcePos) return;
                // Find target block and text position
                ...
                const sourceY = sourcePos.y - containerRect.top;
                const targetY = targetPos.y - containerRect.top;
                // Calculate the X position in the margin (stagger multiple connections)
                const marginX = -(MARGIN_OFFSET + connectionIndex * LINE_SPACING);
                connectionIndex++;
                // Create the path: horizontal to margin, vertical down/up, horizontal to target
                const path = document.createElementNS('http://www.w3.org/2000/svg', 'path');
                // Path goes: source -> left margin -> down/up vertically -> target
                const sourceLeftEdge = 0; // Start from left edge of container
                const d = `M ${sourceLeftEdge} ${sourceY} 
                   H ${marginX} 
                   V ${targetY} 
                   H ${sourceLeftEdge}`;
                ...
                path.setAttribute('class', 'text-connection-line');
                path.style.filter = `drop-shadow(0 0 3px ${connection.color}50)`;
                svg.appendChild(path);
                // Add dots at connection points
                const createDot = (x, y, size = 4)=>{
                    const dot = document.createElementNS('http://www.w3.org/2000/svg', 'circle');
                    dot.setAttribute('cx', String(x));
                    dot.setAttribute('cy', String(y));
                    dot.setAttribute('r', String(size));
                    dot.setAttribute('fill', connection.color);
                    dot.style.filter = `drop-shadow(0 0 4px ${connection.color})`;
                    return dot;
                };
                // Dots at source and target (at the left edge)
                svg.appendChild(createDot(sourceLeftEdge, sourceY, 4));
                svg.appendChild(createDot(sourceLeftEdge, targetY, 4));
                // Small dot at the corner in the margin
                svg.appendChild(createDot(marginX, sourceY, 2));
                svg.appendChild(createDot(marginX, targetY, 2));
            });
        });
    }, [
        blocks,
    ...
    const hasConnections = blocks.some((b)=>b.textConnections && b.textConnections.length > 0);
...
`,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$editor$2f$TextConnectorMenu$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TextConnectorMenu"], {
                ...
                onStartLinking: handleStartTextLinking,
...
//# sourceMappingURL=_d0e34b35._.js.map